...
import { Mail, Lock, User, Eye, EyeOff, Sparkles, Heart, ArrowRight, Star, Zap } from 'lucide-react';
      ...
      <header className="landing-header">
        <div className="container">
          <div className="header-content">
            ...
            >
              <button className="header-btn secondary">Learn More</button>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="auth-form">
              ...
              <motion.div
                ...
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: isSignUp ? 1.4 : 1.3, duration: 0.6 }}
              >
                <div className="input-wrapper">
              ...
              <motion.div
                ...
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: isSignUp ? 1.5 : 1.4, duration: 0.6 }}
              >
                <div className="input-wrapper">
              ...
              <motion.button
                ...
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: isSignUp ? 1.6 : 1.5, duration: 0.6 }}
